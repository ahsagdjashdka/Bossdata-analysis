...
#### 1.1 Scrapy 爬虫（spider_boss）
- 使用 Scrapy 框架爬取 Boss 直聘网站的招聘数据
- 支持多城市批量爬取
- 快速高效，适合大规模数据采集
- 提取职位基本信息，如职位名称、薪资、公司信息等

#### 1.2 Selenium 爬虫（Boss_data）
- 使用 Selenium 模拟浏览器操作，处理动态加载内容
...
1. 爬虫运行需要配置 Cookies，可在 `CookiesMiddlewares.py` 中设置
